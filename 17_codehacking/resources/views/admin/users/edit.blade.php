        ...
        {!! Form::model($user, ['method' => 'PATCH', 'action' => ['App\Http\Controllers\AdminUsersController@update', $user->id], 'files' => true]) !!}    <!-- Opening A Form -->
            ...
            <div class="col-sm-9">
                ...
                <div class="form-group">
                    ...
                    {!! Form::submit('Update User', ['class'=>'btn btn-primary']) !!}   <!-- Generating A Submit Button, 'Create User - name shown in the button, 'btn btn-primary' - value for 'class' attribute -->
                </div>
            </div>
